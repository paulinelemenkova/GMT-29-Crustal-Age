...
grdcut rate.3.2.nc -R20/120/-65/30 -Gio_rate.tif

#
gdalinfo io_rate.tif -stats
#Minimum=0, Maximum=16000, Mean=0.197, StdDev=60.341
# Step-5. Make color palette
#gmt makecpt -Cbatlow -T8.000/1313.000 > ageerror.cpt
gmt makecpt -Cwysiwyg -T0/15000 > rate.cpt
#gmt makecpt --help

# Step-1. Generate a file
ps=IO_Rate.ps
gmt grdimage io_rate.tif -Crate.cpt -R20/120/-65/30 -JQ5.0i -P -I+a15+ne0.75 -Xc -K > $ps

# Add grid
gmt psbasemap -R -J \
    -Bpx204f10a10 -Bpyg20f10a10 -Bsxg5 -Bsyg5 \
    --MAP_TITLE_OFFSET=0.8c \
    -B+t"Spreading Half Rates of Oceanic Lithosphere: Indian Ocean" -O -K >> $ps
    
# Step-7. Add legend
gmt psscale -Dg0.0/-65+w12.0c/0.4c+v+o0.3/0i+ml -R20/120/-65/30 -J -Crate.cpt -W0.01 \
	--FONT_LABEL=7p,Helvetica,dimgray \
	--FONT_ANNOT_PRIMARY=6p,Helvetica,black \
	-Ba10f1+l"Color scale: wysiwyg: 20 well-separated RGB colors [C=RGB]" \
	-I0.2 -By+lmm/yr -O -K >> $ps
...
gmt psconvert IO_Rate.ps -A0.5c -E720 -Tj -Z
