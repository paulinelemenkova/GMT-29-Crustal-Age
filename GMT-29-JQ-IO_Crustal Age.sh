...
grdcut age.3.2.nc -R20/120/-65/30 -Gio_age.tif

#
gdalinfo io_age.tif -stats
#Minimum=0, Maximum=16000, Mean=0.197, StdDev=60.341
# Step-5. Make color palette
gmt makecpt -Cturbo -T0/16000 > age.cpt
# makecpt --help

# Step-1. Generate a file
ps=IO_Age.ps
gmt grdimage io_age.tif -Cage.cpt -R20/120/-65/30 -JQ5.0i -P -I+a15+ne0.75 -Xc -K > $ps

# Add grid
gmt psbasemap -R -J \
    -Bpx204f10a10 -Bpyg20f10a10 -Bsxg5 -Bsyg5 \
    --MAP_TITLE_OFFSET=0.8c \
    -B+t"Age of Oceanic Lithosphere: Indian Ocean" -O -K >> $ps
    
# Step-7. Add legend
gmt psscale -Dg0.0/-65+w12.0c/0.4c+v+o0.3/0i+ml -R20/120/-65/30 -J -Cage.cpt -W0.01 \
	--FONT_LABEL=7p,Helvetica,dimgray \
...
gmt psconvert IO_Age.ps -A0.5c -E720 -Tj -Z
