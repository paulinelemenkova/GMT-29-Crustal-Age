...
grdcut ageerror.3.2.nc -R20/120/-65/30 -Gio_age_error.tif

gdalinfo io_age_error.tif -stats
#Minimum=0, Maximum=16000, Mean=0.197, StdDev=60.341
# Step-5. Make color palette
#gmt makecpt -Cbatlow -T8.000/1313.000 > ageerror.cpt
gmt makecpt -Cjet -T8.000/1313.000 > ageerror.cpt
# makecpt --help

# Step-1. Generate a file
ps=IO_Ageerror.ps
gmt grdimage io_age_error.tif -Cageerror.cpt -R20/120/-65/30 -JQ5.0i -P -I+a15+ne0.75 -Xc -K > $ps

# Add grid
gmt psbasemap -R -J \
    -Bpx204f10a10 -Bpyg20f10a10 -Bsxg5 -Bsyg5 \
    --MAP_TITLE_OFFSET=0.8c \
    -B+t"Age Error of Oceanic Lithosphere: Indian Ocean" -O -K >> $ps
    
# Step-7. Add legend
gmt psscale -Dg0.0/-65+w12.0c/0.4c+v+o0.3/0i+ml -R20/120/-65/30 -J -Cageerror.cpt -W0.01 \
	--FONT_LABEL=7p,Helvetica,dimgray \
	--FONT_ANNOT_PRIMARY=6p,Helvetica,black \
	-Ba1f0.25+l"Color scale: jet Dark to light blue, white, yellow and red [C=RGB]" \
	-I0.2 -By+lM.y -O -K >> $ps
...
-0.5 9.3 Age, spreading rates and spreading symmetry of the ocean crust, 2 arc min grid V-3
EOF

# Step-13. Convert to image file using GhostScript
gmt psconvert IO_Ageerror.ps -A0.5c -E720 -Tj -Z
