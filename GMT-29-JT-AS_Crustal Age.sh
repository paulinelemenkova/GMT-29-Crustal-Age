...
grdcut age.3.2.nc -R47/77/0/31 -Gas_age.tif

#
gdalinfo as_age.tif -stats
#Minimum=0, Maximum=16000, Mean=0.197, StdDev=60.341
# Step-5. Make color palette
gmt makecpt -Cturbo -T6/15996 > age.cpt
# makecpt --help

# Step-1. Generate a file
ps=AS_Age.ps
gmt grdimage as_age.tif -Cage.cpt -R47/77/0/31 -JT62/15/6i -P -I+a15+ne0.75 -Xc -K > $ps
...
# Step-7. Add legend
gmt psscale -Dg0.0/-65+w12.0c/0.4c+v+o0.3/0i+ml -R47/77/0/31 -J -Cage.cpt -W0.01 \
	--FONT_LABEL=7p,Helvetica,dimgray \
